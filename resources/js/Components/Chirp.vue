    ...
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            ...
            <form v-if="editing" @submit.prevent="form.put(route('chirps.update', chirp.id), { onSuccess: () => editing = False})">
                <textarea v-model="form.message" class="mt-4 w-full text-gray-900 border-gray-300 focus:border-indigo-300 focus:ring focus:rig-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"></textarea>
